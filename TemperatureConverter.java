...
public class TemperatureConverter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Farenhiet");
        ...
        jLabel1.setText("> Select any one of the input parameter");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jRadioButton2.isSelected())
        {
            ...
            double farenhiet=(1.8*temp)+32;
            jTextField2.setText(""+farenhiet);
        }
         if(jRadioButton1.isSelected())
        {
            double temp=Double.parseDouble(s1);
            double celsius=(temp-32)*0.56;
